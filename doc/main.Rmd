...
source("../lib/OCRText.R")
source("../lib/Digram.R")
source("../lib/detect.R")
source("../lib/wordsTable.R")
```

### 3.3 - Create bag of words and digram array for groungtruth and tesseract data

* Create the dictionary from groudtruth dataset
* Create the OCR bag of word from tesseract dataset
* Create the digram array including all length of words from groundtruth dataset
...
if(doTruthWordsTable == T) trueText <- wordsTable(truthTest, "truthTestTable") else load("../output/truthTestTable.RData")

if(doOCRWordsTable == T) OCRText <- wordsTable(ocrTest, "OCRTestTable") else load("../output/OCRTestTable.RData")
