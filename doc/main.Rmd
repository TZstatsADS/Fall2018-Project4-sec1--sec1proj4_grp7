...
```{r}
# For our dictionary (derived from groundtruth), we use all 100 documents from groundtruth because we want to get a large dictionary. If we only use training dataset (80 documents), the dictionary is too small to include most of words.
if(doDic == T) {
