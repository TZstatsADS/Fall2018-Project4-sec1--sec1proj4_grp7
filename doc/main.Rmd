...
### 3.2 - Create bag of words and digram array for groungtruth and tesseract data
...
```{r}
if(doDic==T) {
  dictionary("../data/ground_truth/")
} else {
  load("../output/dict.RData")
}

if(doDic==T){
  OCRtext("../data/tesseract/")
} else {
...
### 3.3 - Implement detection algorithm
```{r}
