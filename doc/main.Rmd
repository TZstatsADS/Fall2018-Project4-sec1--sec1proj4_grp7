...
D2. [Letter n-gram](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=1672564)
...
* step 2: Create the list of incorrect words from tesseract OCR train dataset ("OCRtext")
